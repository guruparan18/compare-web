...
def store_comparison(data):
    ...
    if USE_OPTIMIZED:
        return store_comparison_optimized(data, async_mode=True)
...
def get_recent_comparisons(limit=10):
    ...
    if USE_OPTIMIZED:
        return get_recent_comparisons_optimized(limit)
...
def get_comparison(comparison_id):
    ...
    if USE_OPTIMIZED:
        return get_comparison_optimized(comparison_id, include_content=True)
